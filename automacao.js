...
function AlteraRele3(){
    ...
    if(estado_3 === "0"){
        ...
        document.getElementById("rele_3").innerHTML="<div class='rele2_ligado'></div>";
		document.getElementById("botao_3").innerHTML="<a href='/?2_desligar' class='botao_3'>Desliga</a>";
    } else {
